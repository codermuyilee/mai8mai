       ...
       <div id="content" class="grid_9">
	      ...
	      <div class="grid_product">
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_2.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_3.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/top.png" alt="Top"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_4.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_5.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_6.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_7.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/top.png" alt="Top"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/produkt_slid1.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_8.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_9.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="${contextPath}/images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="${contextPath}/images/product_10.png" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
			    <div class="cart">
				   <div class="price">
